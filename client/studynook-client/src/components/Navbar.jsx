...
const Navbar = ({ user, handleLogout }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-transparent pt-4">
      <nav className="w-11/12 mx-auto h-16 px-4 md:px-6 rounded-full bg-[#F6F0E4]/60 dark:bg-[#1e3a8a]/60 border border-[#006B4F]/20 dark:border-[#F6F0E4]/20 backdrop-blur-xl shadow-sm flex items-center justify-between">
